...
static unsigned int imx917_mot_do_factory_verify(struct EEPROM_DRV_FD_DATA *pdata, unsigned int *pGetSensorCalData);
static unsigned int mot_imx917_do_manufacture_info(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int mot_imx917_do_2a_gain(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int mot_imx917_do_pdaf(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
#define IMX917_MOT_EEPROM_ADDR 0x00
#define IMX917_MOT_EEPROM_DATA_SIZE 0x325B
#define IMX917_MOT_SERIAL_NUMBER_ADDR 0x16
#define IMX917_MOT_MNF_ADDR 0x00
#define IMX917_MOT_MNF_DATA_SIZE 38
#define IMX917_MOT_MNF_CHECKSUM_ADDR 0x26
#define IMX917_MOT_AF_ADDR 0x28
#define IMX917_MOT_AF_DATA_SIZE 24
#define IMX917_MOT_AF_CHECKSUM_ADDR 0x40
#define IMX917_MOT_AWB_ADDR 0x42
#define IMX917_MOT_AWB_DATA_SIZE 43
#define IMX917_MOT_AWB_CHECKSUM_ADDR 0x6D
#define IMX917_MOT_LSC_ADDR 0x0C91
#define IMX917_MOT_LSC_DATA_SIZE 1868
#define IMX917_MOT_LSC_CHECKSUM_ADDR 0x13DD
#define IMX917_MOT_PDAF1_ADDR 0x13DF
#define IMX917_MOT_PDAF2_ADDR 0x15CF
#define IMX917_MOT_PDAF_DATA1_SIZE 496
#define IMX917_MOT_PDAF_DATA2_SIZE 1004
#define IMX917_MOT_PDAF_CHECKSUM_ADDR 0x19BB
#define IMX917_MOT_AF_SYNC_DATA_ADDR 0x19BF
#define IMX917_MOT_AF_SYNC_DATA_SIZE 24
#define IMX917_MOT_AF_SYNC_DATA_CHECKSUM_ADDR 0x19D7

#define IMX917_MOT_MTK_NECESSARY_DATA_ADDR 0x19D9
#define IMX917_MOT_MTK_NECESSARY_DATA_SIZE 19
#define IMX917_MOT_MTK_NECESSARY_DATA_CHECKSUM_ADDR 0x19EC

#define IMX917_QSC_DATA_ADDR 0x19EE
#define IMX917_QSC_DATA_SIZE 3072
#define IMX917_QSC_CRC_ADDR 0x25EE

#define IMX917_SPC_DATA_ADDR 0x25F0
#define IMX917_SPC_DATA_SIZE 384
#define IMX917_SPC_CRC_ADDR 0x2770

#define IMX917_FULL_PD_PROC1_ADDR 0x13DF
#define IMX917_FULL_PD_PROC1_SIZE 496
#define IMX917_FULL_PD_PROC2_ADDR 0x15CF
#define IMX917_FULL_PD_PROC2_SIZE 1004
#define IMX917_FULL_PD_SIZE (IMX917_FULL_PD_PROC1_SIZE+IMX917_FULL_PD_PROC2_SIZE)

#define IMX917_PARTIAL_PD_PROC1_ADDR 0x2C39
#define IMX917_PARTIAL_PD_PROC1_SIZE 496
#define IMX917_PARTIAL_PD_PROC2_ADDR 0x2E29
#define IMX917_PARTIAL_PD_PROC2_SIZE 1004
#define IMX917_PARTIAL_PD_SIZE (IMX917_PARTIAL_PD_PROC1_SIZE+IMX917_PARTIAL_PD_PROC2_SIZE)

static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x0000000B, 0x53653030, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000000, 0x00000000, 0x00000000, do_module_version},//CAMERA_CAM_CAL_DATA_MODULE_VERSION
		{0x00000000, 0x00000003, 0x00000008, do_part_number},//CAMERA_CAM_CAL_DATA_PART_NUMBER
		{0x00000001, IMX917_MOT_LSC_ADDR, IMX917_MOT_LSC_DATA_SIZE, mot_do_single_lsc},//CAMERA_CAM_CAL_DATA_SHADING_TABLE
		{0x00000001, 0x00000028, 0x00000047, mot_imx917_do_2a_gain},//CAMERA_CAM_CAL_DATA_3A_GAIN
		{0x00000001, 0x00000000, 0x00000000, mot_imx917_do_pdaf},//CAMERA_CAM_CAL_DATA_PDAF
		...
		{0x00000000, 0x0000000D, 0x00000001, do_lens_id},//CAMERA_CAM_CAL_DATA_LENS_ID
		{0x00000000, 0x00000000, 0x00000000, NULL},//CAMERA_CAM_CAL_DATA_SHADING_TABLE_16_9
		{0x00000001, IMX917_MOT_MNF_ADDR, IMX917_MOT_MNF_DATA_SIZE, mot_imx917_do_manufacture_info}//CAMERA_CAM_CAL_DATA_MANUFACTURE
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT mot_imx917_eeprom = {
	.name = "mot_imx917_eeprom",
	.sensor_type = MAIN_CAMERA,
	.check_layout_function = mot_layout_no_ck,
	.read_function = Common_read_region,
	.mot_do_factory_verify_function = imx917_mot_do_factory_verify,
	.layout = &cal_layout_table,
	.sensor_id = MOT_MERC_IMX917_SENSOR_ID,
	.i2c_write_id = 0xA0,
	.max_size = 0x8000,
	.serial_number_bit = 16,
	.enable_preload = 1,
	.preload_size = IMX917_MOT_EEPROM_DATA_SIZE,
};
		...
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData)
{
	...
	read_data_size = read_data(pdata, pCamCalData->sensorID, pCamCalData->deviceID, IMX917_PARTIAL_PD_PROC1_ADDR,
	                           IMX917_PARTIAL_PD_SIZE + 4, (unsigned char *)tempBuf);
	if (read_data_size <= 0) {
	...
	read_data_size = read_data(pdata, pCamCalData->sensorID, pCamCalData->deviceID, IMX917_PARTIAL_PD_PROC1_ADDR,
	                           IMX917_PARTIAL_PD_SIZE, (unsigned char *)&pCamCalData->PDAF.Data[0]);
	if (read_data_size <= 0) {
		err = CAM_CAL_ERR_NO_PDAF;
		return err;
	}
	...
	read_data_size = read_data(pdata, pCamCalData->sensorID, pCamCalData->deviceID, IMX917_FULL_PD_PROC1_ADDR,
	                           IMX917_FULL_PD_SIZE + 4, (unsigned char *)tempBuf);
	if (read_data_size <= 0) {
		err = CAM_CAL_ERR_NO_PDAF;
		return err;
	}
	...
	read_data_size = read_data(pdata, pCamCalData->sensorID, pCamCalData->deviceID, IMX917_FULL_PD_PROC1_ADDR,
	                           IMX917_FULL_PD_SIZE,
	                           (unsigned char *)&pCamCalData->PDAF.Data[IMX917_PARTIAL_PD_SIZE]);
	if (read_data_size <= 0) {
		err = CAM_CAL_ERR_NO_PDAF;
		return err;
	}

	pCamCalData->PDAF.Size_of_PDAF = IMX917_PARTIAL_PD_SIZE  + IMX917_FULL_PD_SIZE;
	...
	debug_log("First five of full pd: %x, %x, %x, %x, %x\n",
		pCamCalData->PDAF.Data[IMX917_PARTIAL_PD_SIZE],
		pCamCalData->PDAF.Data[IMX917_PARTIAL_PD_SIZE+1],
		pCamCalData->PDAF.Data[IMX917_PARTIAL_PD_SIZE+2],
		pCamCalData->PDAF.Data[IMX917_PARTIAL_PD_SIZE+3],
		pCamCalData->PDAF.Data[IMX917_PARTIAL_PD_SIZE+4]);
...
unsigned int mot_imx917_do_2a_gain(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData)
{
	struct STRUCT_CAM_CAL_DATA_STRUCT *pCamCalData =
				(struct STRUCT_CAM_CAL_DATA_STRUCT *)pGetSensorCalData;
	...
	int af_addr = IMX917_MOT_AF_ADDR;
	int af_size = IMX917_MOT_AF_DATA_SIZE;
	int awb_addr = IMX917_MOT_AWB_ADDR;
	int awb_size = IMX917_MOT_AWB_DATA_SIZE;
	...
	if(pCamCalData->sensorID == MOT_MERC_IMX917_SENSOR_ID) {
		...
		//Terrain's IMX917 AF is close loop driver IC, AF drift is 0, the programmed values is 0xFFFF.
		af_inf_posture = 0;
		af_macro_posture = 0;
...
static unsigned int imx917_mot_do_factory_verify(struct EEPROM_DRV_FD_DATA *pdata, unsigned int *pGetSensorCalData)
{
	...
	read_data_size = read_data(pdata, pCamCalData->sensorID, pCamCalData->deviceID,
			IMX917_MOT_EEPROM_ADDR, IMX917_MOT_EEPROM_DATA_SIZE, (unsigned char *)pCamCalData->DumpAllEepromData);
	if (read_data_size <= 0) {
		return CAM_CAL_ERR_NO_DEVICE;
	}
	//mnf check
	checkSum = (pCamCalData->DumpAllEepromData[IMX917_MOT_MNF_CHECKSUM_ADDR])<< 8
		|(pCamCalData->DumpAllEepromData[IMX917_MOT_MNF_CHECKSUM_ADDR+1]);
	debug_log("checkSum  = 0x%x", checkSum);

	if(check_crc16(pCamCalData->DumpAllEepromData, IMX917_MOT_MNF_DATA_SIZE, checkSum)) {
	...
	memcpy(pCamCalData->serial_number, &pCamCalData->DumpAllEepromData[IMX917_MOT_SERIAL_NUMBER_ADDR],
		pCamCalData->serial_number_bit);

	//af check
	checkSum = (pCamCalData->DumpAllEepromData[IMX917_MOT_AF_CHECKSUM_ADDR])<< 8
		|(pCamCalData->DumpAllEepromData[IMX917_MOT_AF_CHECKSUM_ADDR+1]);
	debug_log("checkSum  = 0x%x", checkSum);

	if(check_crc16(pCamCalData->DumpAllEepromData+IMX917_MOT_AF_ADDR, IMX917_MOT_AF_DATA_SIZE, checkSum)) {
	...
	//awb check
	if((mot_check_awb_data(pCamCalData->DumpAllEepromData+IMX917_MOT_AWB_ADDR, IMX917_MOT_AWB_DATA_SIZE + 2)) == NO_ERRORS) {
	...
	//lsc check
	checkSum = (pCamCalData->DumpAllEepromData[IMX917_MOT_LSC_CHECKSUM_ADDR])<< 8
		|(pCamCalData->DumpAllEepromData[IMX917_MOT_LSC_CHECKSUM_ADDR+1]);
	debug_log("checkSum  = 0x%x", checkSum);

	if(check_crc16(pCamCalData->DumpAllEepromData+IMX917_MOT_LSC_ADDR, IMX917_MOT_LSC_DATA_SIZE, checkSum)) {
	...
	//pdaf check
	checkSum = (pCamCalData->DumpAllEepromData[IMX917_MOT_PDAF_CHECKSUM_ADDR])<< 8
		|(pCamCalData->DumpAllEepromData[IMX917_MOT_PDAF_CHECKSUM_ADDR+1]);
	checkSum1 = (pCamCalData->DumpAllEepromData[IMX917_MOT_PDAF_CHECKSUM_ADDR+2])<< 8
		|(pCamCalData->DumpAllEepromData[IMX917_MOT_PDAF_CHECKSUM_ADDR+3]);
	debug_log("checkSum  = 0x%x, checkSum1 = 0x%x", checkSum, checkSum1);

	if(check_crc16(pCamCalData->DumpAllEepromData+IMX917_MOT_PDAF1_ADDR, IMX917_MOT_PDAF_DATA1_SIZE, checkSum)
		&& check_crc16(pCamCalData->DumpAllEepromData+IMX917_MOT_PDAF2_ADDR, IMX917_MOT_PDAF_DATA2_SIZE, checkSum1)) {
	...
	//af sync data check
	checkSum = (pCamCalData->DumpAllEepromData[IMX917_MOT_AF_SYNC_DATA_CHECKSUM_ADDR])<< 8
		|(pCamCalData->DumpAllEepromData[IMX917_MOT_AF_SYNC_DATA_CHECKSUM_ADDR+1]);
	debug_log("checkSum  = 0x%x", checkSum);
	if(check_crc16(pCamCalData->DumpAllEepromData+IMX917_MOT_AF_SYNC_DATA_ADDR, IMX917_MOT_AF_SYNC_DATA_SIZE, checkSum)) {
	...
	checkSum = (pCamCalData->DumpAllEepromData[IMX917_MOT_MTK_NECESSARY_DATA_CHECKSUM_ADDR])<< 8
		|(pCamCalData->DumpAllEepromData[IMX917_MOT_MTK_NECESSARY_DATA_CHECKSUM_ADDR+1]);
	debug_log("checkSum  = 0x%x", checkSum);
	if(check_crc16(pCamCalData->DumpAllEepromData+IMX917_MOT_MTK_NECESSARY_DATA_ADDR, IMX917_MOT_MTK_NECESSARY_DATA_SIZE, checkSum)) {
	...
	//imx917 qsc data check
	checkSum = (pCamCalData->DumpAllEepromData[IMX917_QSC_CRC_ADDR])<< 8
		|(pCamCalData->DumpAllEepromData[IMX917_QSC_CRC_ADDR+1]);
	debug_log("checkSum  = 0x%x", checkSum);
	if(check_crc16(pCamCalData->DumpAllEepromData+IMX917_QSC_DATA_ADDR, IMX917_QSC_DATA_SIZE, checkSum)) {
	...
	//imx917 spc data check
	checkSum = (pCamCalData->DumpAllEepromData[IMX917_SPC_CRC_ADDR])<< 8
		|(pCamCalData->DumpAllEepromData[IMX917_SPC_CRC_ADDR+1]);
	debug_log("checkSum  = 0x%x", checkSum);
	if(check_crc16(pCamCalData->DumpAllEepromData+IMX917_SPC_DATA_ADDR, IMX917_SPC_DATA_SIZE, checkSum)) {
...
static unsigned imx917_lens_id_to_name(uint8_t id,unsigned int block_size,unsigned char * lens_id,unsigned int err)
{
		...
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData)
{
	...
	//lens_id
        err = imx917_lens_id_to_name(tempBuf[13],block_size,pCamCalData->ManufactureData.lens_id,err);
	//manufacture id
