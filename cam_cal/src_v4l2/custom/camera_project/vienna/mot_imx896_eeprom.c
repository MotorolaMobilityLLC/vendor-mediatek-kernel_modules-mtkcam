...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000003, 0x32443832, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, IMX896_MOT_LSC_ADDR, IMX896_MOT_LSC_DATA_SIZE, mot_do_single_lsc},
		{0x00000001, 0x00000027, 0x00000045, mot_imx896_do_2a_gain},
		{0x00000001, IMX896_MOT_PDAF1_ADDR, IMX896_MOT_PDAF_DATA1_SIZE+IMX896_MOT_PDAF_DATA2_SIZE, mot_do_pdaf},
		...
		{0x00000001, IMX896_MOT_MNF_ADDR, IMX896_MOT_MNF_DATA_SIZE, mot_imx896_do_manufacture_info}
	}
};
