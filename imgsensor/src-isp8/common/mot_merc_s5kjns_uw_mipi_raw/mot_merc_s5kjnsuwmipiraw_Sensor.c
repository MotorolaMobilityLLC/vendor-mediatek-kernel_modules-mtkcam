 ...
 * Filename:
 * ---------
 *	 mot_merc_s5kjnsuwmipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "mot_merc_s5kjnsuwmipiraw_Sensor.h"
...
static struct subdrv_mode_struct mode_struct[] = {
	{
		...
		.mode_setting_table = addr_data_pair_preview_mot_merc_s5kjns_uw,
		.mode_setting_len = ARRAY_SIZE(addr_data_pair_preview_mot_merc_s5kjns_uw),
	...
	},
	{
		...
		.mode_setting_table = addr_data_pair_custom1_mot_merc_s5kjns_uw,
		.mode_setting_len = ARRAY_SIZE(addr_data_pair_custom1_mot_merc_s5kjns_uw),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = MOT_MERC_S5KJNS_UW_SENSOR_ID,
...
static struct subdrv_pw_seq_entry pw_seq[] = {
	...
	{HW_ID_DVDD, {1056000,1056000}, 6000},
	{HW_ID_AVDD, {2800000,2800000},6000},
	{HW_ID_AFVDD, {2804000, 2804000}, 1000},
	{HW_ID_RST, {1}, 17000},
};

const struct subdrv_entry mot_merc_s5kjns_uw_mipi_raw_entry = {
	.name = "mot_merc_s5kjns_uw_mipi_raw",
	.id = MOT_MERC_S5KJNS_UW_SENSOR_ID,
	.pw_seq = pw_seq,
...
{
	DRV_LOG(ctx, "E\n");
	DRV_LOG(ctx, "MOT MERC S5KJNS UW init start\n");
	...
	i2c_table_write(ctx, addr_data_pair_init_mot_merc_s5kjns_uw,
			ARRAY_SIZE(addr_data_pair_init_mot_merc_s5kjns_uw));
	DRV_LOG(ctx, "MOT MERC S5KJNS UW init end\n");
	DRV_LOG(ctx, "X\n");
}
