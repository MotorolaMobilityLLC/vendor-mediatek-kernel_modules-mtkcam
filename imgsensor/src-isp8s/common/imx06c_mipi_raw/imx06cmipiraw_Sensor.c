...
// static u32 imx06c_dcg_ratio_table_ratio16[] = {16000};

// static u32 imx06c_dcg_ratio_table_ratio64[] = {64000};
...
static struct subdrv_mode_struct mode_struct[] = {
	...
	},
	{
		...
		.dcg_info = {
			...
			// .dcg_gain_table = imx06c_dcg_ratio_table_ratio_direct,
			// .dcg_gain_table_size = sizeof(imx06c_dcg_ratio_table_ratio_direct),
		},
	...
	},
	{
		...
		.multi_exposure_ana_gain_range[IMGSENSOR_EXPOSURE_LE].min = REG2GAIN_ROUNDUP(12288),
		.multi_exposure_ana_gain_range[IMGSENSOR_EXPOSURE_LE].max = REG2GAIN_ROUNDDOWN(15872),
		.multi_exposure_ana_gain_range[IMGSENSOR_EXPOSURE_ME].min = REG2GAIN_ROUNDUP(0),
		.multi_exposure_ana_gain_range[IMGSENSOR_EXPOSURE_ME].max = REG2GAIN_ROUNDDOWN(14336),
		.dpc_enabled = true,
	},
	{
